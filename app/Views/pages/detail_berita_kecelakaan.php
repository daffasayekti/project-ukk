                        ...
                        <div class="col-lg-8">
                            <div>
                                ...
                                <p class="fs-13 text-muted mb-0 mt-2">
                                    <span class="mr-1"><i class="fa-solid fa-clock"></i> </span><?= tgl_indo_model_2(date($detailKecelakaan['tanggal_buat'])); ?>
                                    <span class="mr-1 ml-1"><i class="fas fa-eye"></i> </span><?= $detailKecelakaan['banyak_dilihat']; ?> Views
                                </p>
