    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-back">
                <a href="/ekonomi/detail/<?= $beritaEkonomi['slug']; ?>" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
            </div>
            <h1>Edit Post</h1>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form action="/ekonomi/proses_edit/<?= $beritaEkonomi['id_berita']; ?>" method="post" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <input type="hidden" name="slug" value="<?= $beritaEkonomi['slug']; ?>">
                            <input type="hidden" name="created_by" value="<?= $beritaEkonomi['created_by']; ?>">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control <?= ($validation->hasError('penulis_berita')) ? 'is-invalid' : ''; ?>" name="penulis_berita" value="<?= (old('penulis_berita')) ? old('penulis_berita') : $beritaEkonomi['penulis_berita'] ?>" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <select class="form-control selectric" name="kategori_berita">
                                            ...
                                            <?php
                                            if ($beritaEkonomi['kategori_berita'] == 'Kemiskinan') {
                                                echo '<option value="Kemiskinan" selected>Kemiskinan</option>';
                                            } else {
                                                echo '<option value="Kemiskinan">Kemiskinan</option>';
                                            } ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <div id="image-preview" class="image-preview h-100">
                                            <img src="/images/resource_berita/<?= $beritaEkonomi['gambar_berita']; ?>" class="img-thumbnail preview-img" />
