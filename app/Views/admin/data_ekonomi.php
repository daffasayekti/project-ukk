    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item"><a href="/admin/create_berita_ekonomi" class="badge badge-primary py-lg-2" style="box-shadow:0 2px 6px #6777ef">Add Post</a></div>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="width: 15%;" class="text-center">
                                        ...
                                        <a href="/admin/hapus_ekonomi/<?= $value['slug']; ?>" class="btn btn-danger btn-sm ml-1 hapus-ekonomi"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </table>
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Export Data Ekonomi</h5>
...
<script>
    document.getElementById('tipe-file').addEventListener('change', function() {
        ...
        if (tipeFile === 'excel') {
            ...
            document.getElementById('form-download').action = '/admin/export_excel_berita_ekonomi';
            ...
            document.getElementById('form-download').action = '/admin/export_pdf_berita_ekonomi';
        } else {
...
<script>
    const hapusEkonomi = document.querySelectorAll(".hapus-ekonomi")

    for (let i = 0; i < hapusEkonomi.length; i++) {
        hapusEkonomi[i].addEventListener('click', function(e) {
            e.preventDefault()
            const href = $(this).attr('href')
            Swal.fire({
                title: 'Apakah Anda Yakin',
                text: "Ingin Menghapus Berita Ekonomi Tersebut ?",
                icon: 'warning',
