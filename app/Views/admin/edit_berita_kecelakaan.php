                            ...
                            <div class="card-body">
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control <?= ($validation->hasError('judul_berita')) ? 'is-invalid' : ''; ?>" name="judul_berita" value="<?= (old('judul_berita')) ? old('judul_berita') : $beritaKecelakaan['judul_berita'] ?>" autofocus autocomplete="off">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control <?= ($validation->hasError('created_by')) ? 'is-invalid' : ''; ?>" name="created_by" value="<?= (old('created_by')) ? old('created_by') : $beritaKecelakaan['created_by'] ?>" autocomplete="off" readonly>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <select class="form-control selectric" name="kategori_id">
                                            <?php foreach ($kategoriBerita as $value) : ?>
                                                <?php if ($beritaKecelakaan['id_kategori'] == $value['id_kategori']) : ?>
                                                    <option value="<?= $beritaKecelakaan['id_kategori']; ?>" selected><?= $beritaKecelakaan['nama_kategori']; ?></option>
                                                <?php else : ?>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input id="isi_berita" type="hidden" name="isi_berita" value="<?= (old('isi_berita')) ? old('isi_berita') : $beritaKecelakaan['isi_berita'] ?>" class="form-control <?= ($validation->hasError('isi_berita')) ? 'is-invalid' : ''; ?>">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <img src="/assets/images/resource_berita/<?= $beritaKecelakaan['gambar_berita']; ?>" class="img-thumbnail preview-img mb-4" width="250" />
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label"><?= $beritaKecelakaan['gambar_berita']; ?></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
