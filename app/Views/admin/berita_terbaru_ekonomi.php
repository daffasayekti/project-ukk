...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Berita Terbaru Ekonomi</h1>
        </div>

        <div class="section-body">
            <div class="row">
                <?php foreach ($beritaTerbaruEkonomi as $value) : ?>
                        ...
                        <article class="article article-style-c">
                            ...
                            <div class="article-details text-justify">
                                ...
                                <div class="article-title">
                                    <h2><a href="/ekonomi/detail_berita_terbaru_ekonomi/<?= $value['slug']; ?>" style="text-decoration: none;"><?= $value['judul_berita']; ?></a></h2>
                                </div>
