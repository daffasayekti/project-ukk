...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>My Post Kecelakaan</h1>
        </div>

        <div class="section-body">
            <div class="row">
                <?php foreach ($myPostKecelakaan as $value) : ?>
                        ...
                        <article class="article article-style-c">
                            ...
                            <div class="article-details text-justify">
                                ...
                                <div class="article-title">
                                    <h2><a href="/kecelakaan/detail_my_post_kecelakaan/<?= $value['slug']; ?>" style="text-decoration: none;"><?= $value['judul_berita']; ?></a></h2>
                                </div>
