                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="width: 15%;" class="text-center">
                                        ...
                                        <a href="/admin/hapus_olahraga/<?= $value['slug']; ?>" class="btn btn-danger btn-sm ml-1" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Berita Tersebut ?');"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </table>
