                    ...
                    <div class="table-responsive-sm table-striped">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="width: 15%;" class="text-center">
                                        ...
                                        <a href="/admin/hapus_olahraga/<?= $value['slug']; ?>" class="btn btn-danger btn-sm ml-1 hapus-olahraga"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </table>
                        ...
                        <?php if (empty($data_berita)) : ?>
                            <div class="alert alert-danger text-center" role="alert">
                                Data Berita Olahraga Tidak Tersedia!
                            </div>
                        <?php endif; ?>
...
<script>
    const hapusOlahraga = document.querySelectorAll(".hapus-olahraga")

    for (let i = 0; i < hapusOlahraga.length; i++) {
        hapusOlahraga[i].addEventListener('click', function(e) {
            e.preventDefault()
            const href = $(this).attr('href')
            Swal.fire({
                title: 'Apakah Anda Yakin',
                text: "Ingin Menghapus Berita Olahraga Tersebut ?",
                icon: 'warning',
