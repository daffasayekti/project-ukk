                        ...
                        <form action="/admin/proses_edit_politik/<?= $beritaPolitik['id_berita']; ?>" method="post" enctype="multipart/form-data" class="mt-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control <?= ($validation->hasError('created_by')) ? 'is-invalid' : ''; ?>" name="created_by" value="<?= (old('created_by')) ? old('created_by') : $beritaPolitik['created_by'] ?>" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <div id="image-preview" class="image-preview h-100">
                                            <img src="/assets/images/resource_berita/<?= $beritaPolitik['gambar_berita']; ?>" class="img-thumbnail preview-img" />
