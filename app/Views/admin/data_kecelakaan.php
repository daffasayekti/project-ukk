    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item"><a href="/admin/create_berita_kecelakaan" class="badge badge-primary py-lg-2" style="box-shadow:0 2px 6px #6777ef">Add Post</a></div>
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Export Data Kecelakaan</h5>
...
<script>
    document.getElementById('tipe-file').addEventListener('change', function() {
        ...
        if (tipeFile === 'excel') {
            ...
            document.getElementById('form-download').action = '/admin/export_excel_berita_kecelakaan';
            ...
            document.getElementById('form-download').action = '/admin/export_pdf_berita_kecelakaan';
        } else {
